...
[View on GitHub](https://github.com/jaweed3/esp32-jarvis){: .btn .btn-primary} &nbsp; [Read the Docs](README.md){: .btn}
...
**Key insight:** WiFi and ML inference cannot share a core. Core pinning solved instability that priority tuning couldn't.
...
The ACTIVE → IDLE timeout cuts average power draw by **~70%** in typical usage.
...
**Critical constraint:** DRAM (512KB) is the real bottleneck — not PSRAM.
...
¹ Needs extra firmware ² No captive portal
...
- PlatformIO CLI ([install guide](https://platformio.org/install))
- Seeed Studio XIAO ESP32S3 Sense (~$15)
- USB-C cable
...
No. Everything runs on-device. No cloud APIs, no subscription, no data leaving your network.

### Can I use my own wake word?

Yes. The TFLite Micro model can be retrained with your own audio samples.

### How many faces can it recognize?

50–100 face embeddings (128-dim float32) with room for firmware and OTA partitions.

### Is this production-ready?

Phases 1–2 (system framework, WiFi, streaming, dashboard) are complete. Phases 3–6 (wake word, face detection, recognition) are in active development.
